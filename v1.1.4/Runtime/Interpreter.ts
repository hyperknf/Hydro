...
import { Statement, NumericLiteral, BinaryExpression, Program, Identifier, AssignmentExpression, Deletion, ObjectLiteral, CallExpression, StringLiteral, UseLibrary } from "../Frontend/AST"
...
import { EvaluateProgram, EvaluateDeclaration, EvaluateDeletion, EvaluateUseLibrary } from "./Evaluate/Statements"
...
export function Evaluate(ast_node: Statement, environment: Environment): RuntimeValue {
    switch (ast_node.kind) {
        ...
        case "UseLibrary":
            return EvaluateUseLibrary(ast_node as unknown as UseLibrary, environment)
