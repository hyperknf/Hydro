import { Statement, Program, Expression, BinaryExpression, NumericLiteral, StringLiteral, Identifier, Declaration, Deletion, Parameter, Property, ObjectLiteral, CallExpression, MemberExpression, UseLibrary } from "./AST"
...
export default class Parser {
    ...
    private ParseUseLibrary(): Statement {
        this.Eat()
        if (this.At().type != TokenType.String) throw new Error("Expected string after \"use\" keyword")
        const library = this.Eat().value
        return {
            kind: "UseLibrary",
            target: library
        } as UseLibrary
